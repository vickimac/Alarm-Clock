...
/**
 * Pre-made code. 
 * The panel that displays the analogue clock face. 
 * Resizes depending on current window size.
 */
public class ClockPanel extends JPanel {
    ...
    /**
     * Initialises the clock by setting the Model, preferred size and background
     * colour of the frame,
     * 
     * @param m The model, allows it to draw the clock hands depending on the 
    ...
    /**
     * Draws all the visual aspects of the clock onto the panel.
     * 
     * @param g Graphics (but then converts to Graphics2D by calling the 
     *          superclass)
     */
